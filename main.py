...
async def get_github_link(message: types.Message):
    ...
    await message.reply(f'Вот ссылка на GitHub: <a href="https://praktikum.notion.site/kids-ai-465035eb1e3c4409ac05e38a2beb41be">ТЫК</a>', reply_markup=keyboard, parse_mode=ParseMode.HTML)
